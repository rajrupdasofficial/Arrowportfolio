  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Webstackpros.net.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Webstackpros.net, accessible from{" "}
            <a
              href="https://www.webstackpros.net/"
      ...
      <p>
        ...
        <a
          href="https://www.webstackpros.net/blog/category/Use_Of_Cookies_And_Tracking"
          target="_blank">
      ...
      <ul>
        <li>
          <p>By email: webstackadmin@webstackpros.net</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://www.webstackpros.net/contact/"
              rel="external nofollow noopener"
              target="_blank">
              https://www.webstackpros.net/contact/
            </a>
          </p>
        </li>
      </ul>
