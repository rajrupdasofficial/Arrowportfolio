const Terms = () => {
  return (
    <div>
      ...
      <p>Welcome to Webstackpros.net!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Webstackpros.net&apos;s Website, located at
        https://www.webstackpros.net/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Webstackpros.net if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing Webstackpros.net, you agreed
        to use cookies in agreement with the Webstackpros.net&apos;s Privacy
        Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Webstackpros.net and/or its licensors own the
        intellectual property rights for all material on Webstackpros.net. All
        intellectual property rights are reserved. You may access this from
        Webstackpros.net for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Webstackpros.net</li>
        <li>Sell, rent or sub-license material from Webstackpros.net</li>
        <li>Reproduce, duplicate or copy material from Webstackpros.net</li>
        <li>Redistribute content from Webstackpros.net</li>
      </ul>
      ...
      <p>
        ...
        Webstackpros.net does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Webstackpros.net,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Webstackpros.net
      ...
      <p>
        Webstackpros.net reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant Webstackpros.net a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Webstackpros.net; and (d) the
      ...
      <p>
        ...
        e-mail to Webstackpros.net. Please include your name, your organization
      ...
      <p>
        No use of Webstackpros.net&apos;s logo or other artwork will be allowed
